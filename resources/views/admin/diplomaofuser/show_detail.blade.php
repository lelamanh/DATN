						...
						<div class="media">
							...
							<div class="media-body">
								<div class="personal_text">
									<h3 style="font-size:30px;">Họ tên: {{$diplomaofuser->name}}</h3>
                                    ...
                                    <ul class="list basic_info">
                                        <li><a href="#">Loại: {{$diplomaofuser->type}}</a></li>
                                        <li><a href="#">Tên: {{$diplomaofuser->field}}</a></li>
                                        <li><a href="#">Số hiệu: {{$diplomaofuser->user_accept}}</a></li>
                                        <li><a href="#">Nơi cấp: {{$diplomaofuser->level_unit}}</a></li>
                                        <li><a href="#">Xếp loại: {{$diplomaofuser->rating}}</a></li>
                                        <li><a href="#">Ngày cấp: {{!is_null($diplomaofuser->date_issue) ? $diplomaofuser->date_issue : 'Chưa có'}}</a></li>
                                        <br>
                                    </ul>
								</div>
							</div>
